...
from plugins.utility.group_auth import is_group_authorized
...
async def sa(client, message):
    ...
    if message.chat.type in ["group", "supergroup"]:
        if not await is_group_authorized(message.chat.id):
            await message.reply_text("This group is not authorized to use this command.", reply_to_message_id=mid)
            return
